...
public class KNN {
	...
	{
		numFeatures=n; // use subset of all features
	}	
	// Euclidean distance
	...
	KNN(Dataset t1, Dataset t2)
	{
		...
		test=t2;
		numNeighbor=0;
		numFeatures=t1.types.size(); // use all features
	}
	...
	//	System.out.println("#Correct: "+ratio+", size: "+test.data.size()+", ");
